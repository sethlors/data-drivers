...
# Read CSV files
lap_times <- read_csv("raw-data/lap_times.csv")
races <- read_csv("shiny/data/clean-data/races.csv")  # Already filtered for 2018-2024
...
# Save cleaned CSV
write_csv(lap_times_filtered, "shiny/data/clean-data/lap_times.csv")
