...
To streamline the ETL process, we created reusable R functions that wrap the API calls and output clean, consistent data frames for analysis. These functions are stored in our team's GitHub repository under the 'cleaning' folder, allowing easy access and reproducibility.
